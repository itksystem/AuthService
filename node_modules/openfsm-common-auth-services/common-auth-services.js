...
const SQL = {
  USER: {    
    ...
    GET_SECURITY_FACTOR_KEY  : `select * from pa_auth_service.two_factor_user_relations where user_id = $1`,

    GET_PIN_CODE_FACTOR :`select pin_code as "pinCode" from pa_auth_service.users where id = $1`,
    GET_TWO_FACTOR  : `select * from pa_auth_service.two_factor_user_relations where user_id = $1`,
