...
const SQL = {
  USER: {
    ...
    CREATE: `INSERT INTO users (email, password, verification_code) VALUES (?, ?, ?)`,
    ...
    GET_ME : `SELECT email as login, confirmed FROM users WHERE id = ?`,
    GET_CONFIRMED : `SELECT confirmed  FROM users WHERE id = ?`,
    SET_CONFIRMED : `UPDATE users SET confirmed=NOW() WHERE id = ?`,
    SET_UNCONFIRMED : `UPDATE users SET confirmed=NULL WHERE id = ?`,
    GET_VERIFICATION_CODE : `SELECT verification_code  FROM users WHERE id = ?`,
    SET_VERIFICATION_CODE : `UPDATE users SET verification_code=?  WHERE id = ?`,    
    },
  ACCOUNT: {
