...
class ClientServiceHandler {
    ...
    async setSubscription(req, res) {
        try {
            ...
            const data = await response.json();
            if (response.ok) {
                console.log(`setSubscription successfully.`);
                return { success: true, data };
            } else {
                console.log(`setSubscription failed.`);
                return { success: false, status: response.status, data };
            }
        } catch (error) {
            console.log(`setSubscription failed.`);
    ...
    async setProfileImage(req, fileUrls) {
        try {
            ...
            const data = await response.json();
            if (response.ok) {
                logger.info(`setProfileImage image successfully.`);
                return { success: true, data };
            } else {
                logger.error(`setProfileImage image failed.`);
                return { success: false, status: response.status, data };
            }
        } catch (error) {
            logger.error(`setProfileImage image failed.`);
    ...
    async getProfileImage(req, fileUrls) {
        try {
            ...
            const data = await response.json();
            if (response.ok) {
                logger.info(`getProfileImage image successfully.`);
                return { success: true, data };
            } else {
                logger.error(`getProfileImage image failed.`);
                return { success: false, status: response.status, data };
            }
        } catch (error) {
            logger.error(`getProfileImage image failed.`);
    ...
    async getUserIdByEmail(req) {
        try {
            const url = new URL(process.env.CLIENT_GET_USER_BY_EMAIL_URL);            
            const response = await fetch(url, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',                                        
            ...
            const data = await response.json();
            if (response.ok) {
                logger.info(`getUserIdByEmail find success`);
                return { success: true, data };
            } else {
                logger.error(`getUserIdByEmail find failed.`);
                return { success: false, status: response.status, data };                
            }
        } catch (error) {
            logger.error(`getUserIdByEmail find failed.`);
    ...
    async getUserIdByTelegramId(telegramId) {
        try {
            const url = new URL(process.env.CLIENT_GET_USER_BY_TELEGRAM_URL);            
            const response = await fetch(url, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',                                        
            ...
            const data = await response.json();
            if (response.ok) {
                logger.info(`getUserIdByTelegramId  find success`);
                return { success: true, data };
            } else {
                logger.error(`getUserIdByTelegramId find failed.`);
                return { success: false, status: response.status, data };                
            }
        } catch (error) {
            logger.error(`getUserIdByTelegramId find failed.`);
    ...
    async createProfileByTelegramId(telegramId, userId) {
        try {
            const url = new URL(process.env.CLIENT_CREATE_PROFILE_BY_TELEGRAM_URL);            
            const response = await fetch(url, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',                                        
            ...
            const data = await response.json();
            if (response.ok) {
                logger.info(`createProfileByTelegramId success`);
                return { success: true, data };
            } else {
                logger.error(`createProfileByTelegramId  failed.`);
                return { success: false, status: response.status, data };                
            }
        } catch (error) {
            logger.error(`createProfileByTelegramId  failed.`);
...
async updateProfileByTelegramId(user = null) {
    try {
        if(!user) return null;
        const url = new URL(process.env.CLIENT_UPDATE_TELEGRAM_PROFILE_URL);            
        const response = await fetch(url, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',                                        
        ...
        const data = await response.json();
        if (response.ok) {
            logger.info(`updateProfileByTelegramId success`);
            return { success: true, data };
        } else {
            logger.error(`updateProfileByTelegramId  failed.`);
            return { success: false, status: response.status, data };                
        }
    } catch (error) {
        logger.error(`updateProfileByTelegramId failed.`);
