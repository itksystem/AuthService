...
const { register, login, logout, health, getPermissions, checkToken, getMe, checkVerificationCode, resendVerificationCode, checkTelegramAuthorization } = require('../controllers/authController');
